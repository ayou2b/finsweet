...
function page() {
  return (
    <Fragment>
      ...
      <section className="lg:h-[90vh] relative w-full px-14 sm:px-16 mb-20 lg:m-0 md:px-20 lg:px-24 xl:px-28 text-center flex flex-col items-center justify-center gap-12">
      ...
      <section className="px-14 py-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 flex flex-col items-center gap-12 lg:flex-row lg:items-start text-center lg:text-start bg-[#F0F2FE]">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 flex flex-col items-center gap-12">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 flex flex-col lg:flex-row lg:items-start items-center gap-12">
        ...
        <div className="flex flex-col items-center w-full gap-10 md:grid md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col gap-3 bg-[#E0E4FC] rounded-lg">
            <Image src={profile_1} alt="" className="rounded-lg w-full"></Image>
          ...
          <div className="flex flex-col gap-3 bg-[#E0E4FC] rounded-lg">
            <Image src={profile_2} alt="" className="rounded-lg w-full"></Image>
            <div className="flex p-3 flex-col gap-2 lg:items-start items-center">
              <h4 className="text-[18px] font-semibold tewt-[#1D2130]">
                Jack Newman
              </h4>
          ...
          <div className="flex flex-col gap-3 bg-[#E0E4FC] rounded-lg">
            <Image src={profile_4} alt="" className="rounded-lg w-full"></Image>
            <div className="flex p-3 flex-col gap-2 lg:items-start items-center">
              <h4 className="text-[18px] font-semibold tewt-[#1D2130]">
                Sarinia Martins
              </h4>
          ...
          <div className="flex flex-col gap-3 bg-[#E0E4FC] rounded-lg">
            <Image src={profile_3} alt="" className="rounded-lg w-full"></Image>
            <div className="flex p-3 flex-col gap-2 lg:items-start items-center">
              <h4 className="text-[18px] font-semibold tewt-[#1D2130]">
                Spencer Wright
              </h4>
          ...
          <div className="flex flex-col gap-3 bg-[#E0E4FC] rounded-lg">
            <Image src={profile_5} alt="" className="rounded-lg w-full"></Image>
            <div className="flex p-3 flex-col gap-2 lg:items-start items-center">
              <h4 className="text-[18px] font-semibold tewt-[#1D2130]">
                Caroline Ming
              </h4>
          ...
          <div className="flex flex-col gap-3 bg-[#E0E4FC] rounded-lg">
            <Image src={profile_6} alt="" className="rounded-lg w-full"></Image>
            <div className="flex p-3 flex-col gap-2 lg:items-start items-center">
              <h4 className="text-[18px] font-semibold tewt-[#1D2130]">
                Anna Mills
              </h4>
