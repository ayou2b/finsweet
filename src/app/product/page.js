...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-14 h-[90vh] relative transition-all sm:px-16 md:px-20 lg:px-24 xl:px-28  py-14 w-full text-center lg:text-start flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-12 lg:flex-row lg:justify-between">
          ...
          <Image
            src={hero_image}
            alt=""
            className="max-w-[500px] 2xl:max-w-[650px] w-full object-cover relative z-40"
          ></Image>
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20  w-full flex items-center justify-center ">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-10  lg:flex md:flex-row md:items-center md:justify-between">
      ...
      <section className="w-full flex items-center justify-center">
        <div className="bg-gradient-to-r from-cyan-500/25 2xl:max-w-[1300px] w-full to-blue-500/16 pt-20 mb-20">
      ...
      <section className="px-14 relative sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 text-center lg:text-start  w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-12 lg:justify-between lg:flex-row ">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 text-center lg:text-start w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-12 lg:justify-between lg:flex-row-reverse ">
