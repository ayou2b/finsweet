...
export default function Home() {
  ...
  return (
    <Fragment>
      ...
      <section className="px-14 sm:px-16 transition-all md:px-20 lg:px-24 xl:px-28 mb-20 mt-24 text-center flex flex-col items-center justify-center w-full gap-10 relative">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20">
        ...
        <div className="flex bg-[#E0E4FC] p-12 rounded-xl flex-col items-center gap-10 lg:gap-14 text-center lg:text-start lg:flex-row lg:justify-between lg:items-start">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 flex flex-col items-center lg:text-start text-center lg:flex-row lg:items-start lg:justify-between w-full gap-10">
      ...
      <section className="w-full transition-all bg-gradient-to-r from-cyan-500/20 to-blue-500/10  px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 py-20 text-center lg:text-start">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 text-center lg:text-start gap-10 flex flex-col items-center lg:flex-row lg:justify-between lg:items-start">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 text-center flex flex-col items-center gap-10">
