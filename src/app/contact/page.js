...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-14 sm:px-16 transition-al relativel md:px-20 lg:px-24 xl:px-28 mb-20 mt-20 flex flex-col items-center gap-14 text-center lg:text-start">
        <h1 className="text-[30px] font-bold  relative z-40 text-[#1D2130]">
          Get in touch with us
        </h1>
        <div className="bg-[#F0F2FE] p-12 rounded-lg relative z-40 flex flex-col  items-center gap-10  lg:items-start">
