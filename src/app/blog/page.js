...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 relative flex flex-col  gap-16 mt-20 items-center">
      ...
      <section className="px-14 sm:px-16 md:px-20 w-full text-center lg:text-start lg:px-24 xl:px-28 mb-20 flex flex-col items-center gap-10">
        <h2 className="text-[25px] font-semibold  text-[#1D2130]">All posts</h2>
        <div className="flex flex-col items-center w-full lg:justify-between lg:place-content-between gap-8 md:grid md:grid-cols-2 lg:grid-cols-3">
          <Link
            href="/blog-post"
