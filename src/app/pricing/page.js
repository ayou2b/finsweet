...
function Page() {
  ...
  return (
    <Fragment>
      ...
      <section className=" relative transition-all px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 mt-14 flex flex-col items-center gap-14 overflow-hidden">
          ...
          <div className="flex flex-col relative z-30 items-center gap-12 lg:flex-row lg:justify-between">
            <div className=" bg-white shadow-4xl rounded-3xl max-w-[350px] text-center py-6 lg:text-start  flex flex-col items-center lg:items-start gap-4">
              ...
              <div className="flex px-7 flex-col items-center gap-2 lg:items-start w-full">
                <h2 className="text-[25px] font-bold  text-[#1D2130]">Free</h2>
            ...
            <div className="bg-gradient-to-r  shadow-4xl border-[2px] border-[#6B7CFF] from-[rgb(215,231,249)] to-[rgb(213,244,236)] rounded-3xl max-w-[350px] text-center py-6 lg:text-start  flex flex-col items-center lg:items-start gap-4">
              ...
              <div className="flex px-7 flex-col items-center gap-2 lg:items-start w-full">
                <h2 className="text-[25px] font-bold  text-[#1D2130]">$342 </h2>
            ...
            <div className="bg-white  shadow-4xl rounded-3xl max-w-[350px] text-center py-6 lg:text-start  flex flex-col items-center lg:items-start gap-4">
              ...
              <div className="flex px-7 flex-col items-center gap-2 lg:items-start w-full">
                <h2 className="text-[25px] font-bold  text-[#1D2130]">$234</h2>
        ...
        {yearly === true && (
          <div className="flex flex-col relative z-30 items-center gap-12 lg:flex-row lg:justify-between">
            ...
            <div className="bg-white  shadow-4xl rounded-3xl max-w-[350px] text-center py-6 lg:text-start  flex flex-col items-center lg:items-start gap-4">
              ...
              <div className="flex px-7 flex-col items-center gap-2 lg:items-start w-full">
                <h2 className="text-[25px] font-bold  text-[#1D2130]">$2234</h2>
      ...
      <section className=" transition-all px-14 text-center lg:text-start sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20">
        <div className="bg-[#F0F2FE] py-14 px-12  rounded-lg flex flex-col items-center gap-12 lg:flex-row lg:items-start lg:justify-between w-full">
