...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-14 relative sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-12 mt-16 text-center w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px]  flex flex-col items-center lg:items-start gap-12">
          <div className="flex flex-col relative z-30 items-center lg:items-start lg:text-start gap-3">
      ...
      <section className=" text-center lg:text-start  px-16 sm:px-20 md:px-40 lg:px-44 xl:px-48 mb-20 flex items-center justify-center w-full">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col  text-center lg:text-start items-center gap-10 w-full md:grid md:grid-cols-2 lg:flex lg:flex-row lg:justify-between">
            <Link
              href="/blog-post"
